...
if (!dbExists) {
  ...
  const createCommentSQL = 'CREATE TABLE comment (id INTEGER PRIMARY KEY AUTOINCREMENT, job_id INTEGER, interview_id INTEGER, note TEXT NOT NULL, title NOT NULL, FOREIGN KEY (job_id) REFERENCES job (id), FOREIGN KEY (interview_id) REFERENCES interview (id))';
